...
function createValidation(config) {
    function validate(_a, cb) {
        ...
        function createError(overrides = {}) {
            ...
            const error = new ValidationError_1.default(ValidationError_1.default.formatError(overrides.message || message, nextParams), value, nextParams.path, overrides.type || name);
