...
const sortFields_1 = __importDefault(require("./util/sortFields"));
const sortByKeyOrder_1 = __importDefault(require("./util/sortByKeyOrder"));
...
class ObjectSchema extends schema_1.default {
    constructor(spec) {
        super({
            type: 'object',
        });
    ...
    _cast(_value, options = {}) {
        ...
        for (const prop of props) {
            ...
            if (field) {
                ...
                let fieldSpec = field instanceof schema_1.default ? field.spec : undefined;
    ...
    concat(schema) {
        ...
        for (let [field, schemaOrRef] of Object.entries(this.fields)) {
            ...
            else if (target instanceof schema_1.default &&
                schemaOrRef instanceof schema_1.default) {
    ...
    partial() {
        ...
        for (const [key, schema] of Object.entries(this.fields)) {
            partial[key] = schema instanceof schema_1.default ? schema.optional() : schema;
        }
    ...
    deepPartial() {
        ...
        for (const [key, schema] of Object.entries(this.fields)) {
            if (schema instanceof ObjectSchema)
                ...
                partial[key] =
                    schema instanceof schema_1.default ? schema.optional() : schema;
        }
        return this.setFields(partial);
    }
    pick(keys) {
