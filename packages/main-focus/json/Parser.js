...
exports.Parser = exports.ARRAY = exports.OBJECT = exports.KEY = exports.VALUE = exports.LEFT_BRACKET = exports.LEFT_BRACE = void 0;
/*global Buffer*/
    ...
    */
    onToken(token, value) {
        if (this.state === exports.VALUE) {
            ...
            else if (token === exports.LEFT_BRACE) {
                this.push();
                if (this.value) {
            ...
            else if (token === exports.LEFT_BRACKET) {
                this.push();
                if (this.value) {
                    this.value = this.value[this.key] = [];
                }
        ...
        else if (this.state === exports.KEY) {
            if (token === STRING) {
                this.key = value;
                this.state = COLON;
            }
            ...
            if (token === COMMA) {
                ...
                else if (this.mode === exports.OBJECT) {
                    this.state = exports.KEY;
                }
            }
            else if (token === RIGHT_BRACKET && this.mode === exports.ARRAY || token === RIGHT_BRACE && this.mode === exports.OBJECT) {
                this.pop();
            }
            else {
                return this.parseError(token, value);
    ...
    write(buffer) {
        ...
        for (let i = 0, l = buffer.length; i < l; i++) {
            if (this.tState === START) {
                ...
                this.offset++;
                if (n === 0x7b) {
                    this.onToken(exports.LEFT_BRACE, "{"); // {
                }
                else if (n === 0x7d) {
                    this.onToken(RIGHT_BRACE, "}"); // }
                }
                else if (n === 0x5b) {
                    this.onToken(exports.LEFT_BRACKET, "["); // [
                }
                else if (n === 0x5d) {
