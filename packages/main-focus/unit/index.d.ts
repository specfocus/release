...
export declare const CURRENT = "electric-current";
/** Unit of mass density kilogram per cubic meter kg/m3 */
export declare const DENSITY = "mass-density";
/** Unit of electric charge, quantity of electricity (coulomb C) */
export declare const ELECTRICITY = "electric-charge";
/** Unit of electric potential difference, electromotive force (volt V) */
export declare const ELECTROMOTIVE_FORCE = "electric-potential-difference";
...
export declare const ENERGY_DENDITY = "energy-density";
...
export declare const LIGHT = "luminous-intensity";
/** Unit of luminance (candela per square meter cd/m2) */
export declare const LUMINANCE = "luminance";
/** Unit of magnetic flux (weber Wb) */
export declare const MAGNETIC_FLUX = "magnetic flux";
/** Unit of magnetic flux density (tesla, T) */
export declare const MAGNETIC_FLUX_DENSITY = "magnetic-flux-density";
/** Unit of mass (kilogram) */
export declare const MASS = "mass";
/** Unit of power, radiant flux (watt W) */
export declare const POWER = "radiant-flux";
/** Unit of pressure, stress (pascal Pa N/m2) */
export declare const PRESURE = "presure";
/** Unit of electric resistance (ohm) */
export declare const RESISTANCE = "electric-resistance";
/** Unit of amount of substance (mole) */
export declare const SUBSTANCE = "amount-of-substance";
/** Unit of thermodynamic temperature (kelvin	K) */
export declare const TEMPERATURE = "thermodynamic-temperature";
/** Unit of time (second) */
...
export declare const WORK = "quantity-of-heat";
export declare const UNITS: readonly ["acceleration", "angle", "area", "electric-current", "mass-density", "electric-charge", "electric-potential-difference", "force", "frequency", "length", "luminous-intensity", "luminance", "mass", "radiant-flux", "presure", "electric-resistance", "amount-of-substance", "thermodynamic-temperature", "time", "velocity", "volume", "wave"];
