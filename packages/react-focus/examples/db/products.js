...
exports.default = db => {
    let id = 0;
    return db.categories.reduce((acc, category) => [
        ...acc,
        ...Array.from(Array(10).keys()).map(index => {
            const width = (0, utils_1.randomFloat)(10, 40);
            const height = (0, utils_1.randomFloat)(10, 40);
            return {
                id: id++,
                ...
                stock: (0, utils_1.weightedBoolean)(10)
                    ? 0
                    : en_1.datatype.number({ min: 0, max: 150 }),
                sales: 0,
            };
        }),
    ], []);
