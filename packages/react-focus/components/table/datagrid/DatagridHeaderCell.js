...
const DatagridHeaderCell = (props) => {
    const { className, classes: classesOverride, field, currentSort, updateSort, isSorting } = props, rest = __rest(props, ["className", "classes", "field", "currentSort", "updateSort", "isSorting"]);
    const resource = (0, core_1.useResourceContext)(props);
    const classes = useStyles(props);
    const translate = (0, core_1.useTranslate)();
    return ((0, jsx_runtime_1.jsx)(material_1.TableCell, Object.assign({ className: (0, classnames_1.default)(className, field.props.headerClassName), align: field.props.textAlign, variant: "head" }, rest, { children: updateSort &&
