    ...
    namespace resources {
        export namespace customers_1 {
            ...
            export namespace fields {
                ...
                export const has_newsletter: string;
                export const has_ordered: string;
                export const last_name: string;
                export const last_seen: string;
                export const last_seen_gte: string;
                export const latest_purchase: string;
                const name_2: string;
            ...
            export namespace filters {
                export const last_visited: string;
                ...
                const has_ordered_1: string;
                export { has_ordered_1 as has_ordered };
                const has_newsletter_1: string;
                export { has_newsletter_1 as has_newsletter };
        ...
        export namespace invoices {
            ...
            export namespace fields_2 {
                ...
                export const total_ex_taxes: string;
                export const delivery_fees: string;
                const taxes_1: string;
                export { taxes_1 as taxes };
            }
