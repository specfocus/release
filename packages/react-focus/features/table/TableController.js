...
const TableController = () => {
    ...
    (0, react_1.useEffect)(() => {
        ...
        /*
        tools: Object.values({
          // columns: () => <ToolColumnsButton disabled={pane === 'columns'} onClick={() => setWidget('columns')} />,
          // density,
          // filter: () => <DataFilterButton disabled={pane === 'filter'} onClick={() => setWidget('filter')} />,
          // sort: () => <DataSortOrderButton disabled={pane === 'sort'} onClick={() => setWidget('sort')} />,
          // export: () => <DataExportButton disabled={pane === 'export'} onClick={() => setWidget('export')} />
        }),
        panes: {
