...
interface Props {
    children: (mutate: (event?: any, callTimePayload?: any, callTimeOptions?: any) => void | Promise<any>, params: ChildrenFuncParams) => JSX.Element;
    type: string;
    resource?: string;
    payload?: any;
    options?: any;
 ...
 * );
 */
declare const Mutation: ({ children, type, resource, payload, options, }: Props) => JSX.Element;
