...
export declare const CRUD_UPDATE_MANY = "CRUD_UPDATE_MANY";
...
export declare const CRUD_UPDATE_MANY_LOADING = "CRUD_UPDATE_MANY_LOADING";
...
export declare const CRUD_UPDATE_MANY_FAILURE = "CRUD_UPDATE_MANY_FAILURE";
...
export declare const CRUD_UPDATE_MANY_SUCCESS = "CRUD_UPDATE_MANY_SUCCESS";
