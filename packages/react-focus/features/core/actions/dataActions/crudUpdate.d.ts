...
export declare const crudUpdate: (resource: string, id: Identifier, data: any, previousData: any, basePath: string, redirectTo?: RedirectionSideEffect, refresh?: RefreshSideEffect) => CrudUpdateAction;
interface RequestPayload {
    id: Identifier;
    data: any;
    previousData?: any;
}
export declare const CRUD_UPDATE = "CRUD_UPDATE";
...
export declare const CRUD_UPDATE_LOADING = "CRUD_UPDATE_LOADING";
...
export declare const CRUD_UPDATE_FAILURE = "CRUD_UPDATE_FAILURE";
...
export declare const CRUD_UPDATE_SUCCESS = "CRUD_UPDATE_SUCCESS";
