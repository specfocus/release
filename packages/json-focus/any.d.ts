export declare type Any<nullable extends boolean = false, optional extends boolean = false> = Array<nullable, optional> | Shape<nullable, optional> | Tuple<nullable, optional> | Value<nullable, optional> | Date;
export declare type Array<nullable extends boolean = false, optional extends boolean = false> = Any<nullable, optional>[];
export declare type NumberOrString<nullable extends boolean = false, optional extends boolean = false> = number | string | (nullable extends true ? null : never) | (optional extends true ? undefined : never);
