...
import BaseSchema, { AnySchema, Asserts, Config, Defined, NotNull, SchemaInnerTypeDescription, SchemaSpec, SetFlag, Thunk, ToggleDefault } from './base';
...
export declare function create<C extends AnyObject = AnyObject, T extends AnySchema | Lazy<any, any> = AnySchema>(type?: T): ArraySchema<T, Config<C, "">, Asserts<T>[]>;
...
export default class ArraySchema<T extends AnySchema | Lazy<any, any>, C extends Config<any, any> = Config, TIn extends Maybe<Asserts<T>[]> = Asserts<T>[] | undefined> extends BaseSchema<TIn, C> {
    ...
    protected _validate(_value: any, options: InternalOptions<C>, callback: Callback): void;
