...
import { ReferenceSet, default as Reference } from './reference';
import { Test, TestConfig, TestFunction } from './validate/createValidation';
...
export default abstract class BaseSchema<TType = any, TConfig extends Config<any, any> = Config> {
     ...
     */
    cast(value: any, options?: CastOptions<TConfig['context']>): this['__outputType'];
    protected _cast(rawValue: any, _options: CastOptions<TConfig['context']>): any;
    protected _validate(_value: any, options: InternalOptions<TConfig['context']>, cb: Callback): void;
    validate(value: any, options?: ValidateOptions<TConfig['context']>): Promise<this['__outputType']>;
    validateSync(value: any, options?: ValidateOptions<TConfig['context']>): this['__outputType'];
    ...
    notOneOf<U extends TType>(enums: (Maybe<U> | Reference)[], message?: Message<{
        values: any;
    }>): this;
