...
const reference_1 = __importStar(require("./reference"));
const createValidation_1 = __importDefault(require("./validate/createValidation"));
...
const toArray_1 = __importDefault(require("./validate/toArray"));
...
class BaseSchema {
    constructor(options) {
        ...
        this.conditions = [];
        this.internalTests = {};
        this._whitelist = new reference_1.ReferenceSet();
        this._blacklist = new reference_1.ReferenceSet();
     ...
     */
    cast(value, options = {}) {
        const resolvedSchema = this.resolve(Object.assign({ value }, options));
        const result = resolvedSchema._cast(value, options);
        if (options.assert !== false && !resolvedSchema.isType(result)) {
            const formattedValue = (0, printValue_1.default)(value);
            const formattedResult = (0, printValue_1.default)(result);
